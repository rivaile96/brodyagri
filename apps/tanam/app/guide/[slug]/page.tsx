...
export default function GuideDetailPage() {
 ...
 <Link href="/guide" className="w-9 h-9 rounded-full border flex items-center justify-center text-emerald-300 hover:text-white transition-colors">
 ...
 {media.drainage_note && (
 <div className="p-3.5 rounded-2xl border text-xs text-emerald-100 leading-relaxed">
 ...
 <div key={idx} className="p-3 rounded-2xl border text-xs text-emerald-100/90 flex items-start gap-2.5">
 ...
 <div className="p-3 rounded-xl border text-xs text-emerald-100">
