    ...
    <AppShell title="Perencanaan Tanam">
      <div className="space-y-5">
        ...
        {step > 1 && state.climate && (
          <div className="p-3.5 rounded-2xl bg-[#14231b]/90 border border-emerald-800/40 shadow-sm space-y-2 backdrop-blur-md">
            ...
            <div className="flex items-center gap-1.5 overflow-x-auto pb-0.5 scrollbar-hidden text-[11px]">
              ...
              <div className="shrink-0 flex items-center gap-1 px-2.5 py-1 rounded-xl bg-[#0c1410] border border-emerald-900/80 text-emerald-200">
              ...
              <div className={cn(
                ...
                step >= 2 ? "bg-[#0c1410] border-emerald-900/80 text-emerald-200" : "bg-zinc-900/40 border-zinc-800 text-zinc-500"
              )}>
          ...
          >
            ...
            {step === 1 && (
              <div className="space-y-4">
                ...
                {!state.climate ? (
                  <div className="rounded-3xl bg-[#14231b]/80 border border-emerald-800/40 p-8 text-center space-y-4 backdrop-blur-md shadow-md">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="rounded-3xl bg-[#14231b]/90 border border-emerald-800/40 p-5 space-y-3 shadow-md">
                      <div className="flex items-start justify-between gap-3 border-b border-emerald-900/80 pb-3">
                        ...
                        <button
                          onClick={detectLocation}
                          className="text-emerald-400 hover:text-white p-2 rounded-xl bg-emerald-950/50 border border-emerald-800/40 transition-colors shrink-0"
                      ...
                      <div className="grid grid-cols-2 gap-2.5 pt-1">
                        <div className="bg-[#0c1410]/70 p-3.5 rounded-2xl border border-emerald-900/60 space-y-1">
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-3xl bg-gradient-to-br from-[#1b3628] to-[#14281e] border border-emerald-600/40 space-y-2.5 shadow-md">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-[11px] text-emerald-100/90">
                    <div className="bg-[#0c1410]/60 p-2.5 rounded-2xl border border-emerald-900/60">
                  ...
                  {varietiesWithScore.map((v, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="p-2.5 rounded-2xl bg-[#0c1410]/60 border border-emerald-900/60 text-[11px] text-emerald-200/90">
                ...
                <div className="pt-2 border-t border-emerald-900/80">
                  {!showCustomInput ? (
                    <button
                      ...
                      className="w-full py-3.5 px-4 rounded-3xl border border-dashed border-emerald-700/60 hover:border-emerald-500 text-emerald-300 hover:text-white text-xs font-bold flex items-center justify-center gap-2 transition-all bg-[#14231b]/40"
                    >
                      <Plus className="w-4 h-4 text-emerald-400" />
                      <span>Input Varietas Sendiri (Diuji terhadap 4 Parameter)</span>
                    </button>
                  ) : (
                    <div className="rounded-3xl bg-[#14231b]/95 border border-emerald-700/60 p-5 space-y-3">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 bg-[#0c1410] border border-emerald-800 rounded-2xl px-3.5 py-2.5 text-xs text-white placeholder-emerald-800/60 focus:outline-none focus:border-emerald-500"
                        />
                        <button
            ...
            {step === 6 && (
              <div className="space-y-4">
                ...
                <div className="rounded-3xl bg-[#14231b]/90 border border-emerald-800/40 p-5 space-y-4 backdrop-blur-md shadow-md">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0c1410] border border-emerald-800 rounded-2xl px-4 py-3 text-sm text-white placeholder-emerald-800/60 focus:outline-none focus:border-emerald-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#0c1410] border border-emerald-800 rounded-2xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500"
                    />
                  </div>

                  {/* Summary Box History Chain */}
                  <div className="p-4 rounded-2xl bg-[#0c1410]/70 border border-emerald-900/60 space-y-2 text-xs text-emerald-100">
        ...
        <div className="flex items-center justify-between gap-3 pt-4 border-t border-emerald-900/80">
          {step > 1 ? (
            <button
              onClick={() => setStep(s => s - 1)}
              className="px-5 py-3 rounded-full border border-emerald-700/60 text-emerald-200 hover:text-white text-xs font-bold transition-all flex items-center gap-1.5 active:scale-95"
            >
