      ...
      <div className="space-y-6">
        ...
        {!result ? (
          ...
          >
            ...
            <div className="rounded-3xl bg-[#14231b]/90 border border-emerald-800/40 p-5 space-y-3.5 backdrop-blur-md shadow-md">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#0c1410] border border-emerald-800 rounded-2xl px-4 py-2.5 text-xs text-white placeholder-emerald-800/60 focus:outline-none focus:border-emerald-500"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#0c1410] border border-emerald-800 rounded-2xl p-3 text-xs text-white placeholder-emerald-800/60 focus:outline-none focus:border-emerald-500 resize-none"
                  />
                </div>
              </div>
            </div>
          ...
          >
            <div className="rounded-3xl bg-[#14231b]/90 border border-emerald-800/40 p-5 space-y-4 backdrop-blur-md shadow-md">
              ...
              {result.home_remedy && (
                <div className="p-4 rounded-2xl bg-gradient-to-br from-[#1b3628] to-[#14281e] border border-emerald-600/40 space-y-2">
                  ...
                  <div className="text-xs text-emerald-100/90 leading-relaxed bg-[#0c1410]/70 p-3 rounded-xl border border-emerald-900/60 space-y-1.5">
              ...
              {result.chemical_remedy && (
                <div className="p-4 rounded-2xl bg-[#0c1410]/60 border border-emerald-900/60 space-y-1.5">
              ...
              {result.preventions?.length > 0 && (
                <div className="space-y-1.5 pt-2 border-t border-emerald-900/80">
            ...
            <button
              onClick={resetForm}
              className="w-full py-3.5 rounded-full bg-[#14231b] border border-emerald-700/60 hover:border-emerald-500 text-white font-bold text-xs flex items-center justify-center gap-2 transition-all"
            >
